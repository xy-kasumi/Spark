...
bench = (
    cq.Assembly()
    .add(fc.make_channel(300), name="left", loc=cq.Location((channel_sz / 2, 0, channel_sz / 2)), color=cq.Color("gray"))
    .add(fc.make_channel(300), name="right", loc=cq.Location((frame_width - channel_sz / 2, 0, channel_sz / 2)), color=cq.Color("gray"))
    .add(fc.make_channel(frame_width ), name="bottom", loc=cq.Location((0, 0, 0), (0, 1, 0), 90), color=cq.Color("gray"))
    .add(fc.make_channel(frame_width ), name="top", loc=cq.Location((0, 0, 320), (0, 1, 0), 90), color=cq.Color("gray"))
    .add(din.TopHat(300).cq_object, name="din1", color=cq.Color("gray"))
    .add(din.TopHat(300).cq_object, name="din2", color=cq.Color("gray"))
    .add(din.TopHat(300).cq_object, name="din3", color=cq.Color("gray"))
    .add(fj.make_joint(), name="j_botleft", loc=cq.Location((channel_sz, channel_sz / 2, channel_sz / 2), (1, 0, 0), 90), color=cq.Color("cyan"))
    .add(fj.make_joint(), name="j_botright", loc=cq.Location((frame_width - channel_sz, channel_sz / 2, channel_sz / 2), (90, -90, 0)), color=cq.Color("cyan"))
    .add(fj.make_joint(), name="j_topleft", loc=cq.Location((channel_sz, -channel_sz / 2, frame_hlen + channel_sz / 2), (-90, 0, 0)), color=cq.Color("cyan"))
    .add(fj.make_joint(), name="j_topright", loc=cq.Location((frame_width - channel_sz, -channel_sz / 2, frame_hlen + channel_sz / 2), (-90, 90, 0)), color=cq.Color("cyan"))
    ...
    .add(cover, loc=cq.Location((150, 72.5, 160)), color=cq.Color("cyan"))
    .add(ff.make_foot(), loc=cq.Location((frame_width, 77, -channel_sz/2), (0, 0, 180)), color=cq.Color("cyan"))
)
